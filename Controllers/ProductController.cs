...
{       
    ...
    {   
        ...
        {
            ViewBag.Ingredients = await ingredients.GetAllAsync(); // To select ingredients for new product
		...
		public async Task<IActionResult> AddEdit(Product product, int[] ingredientIds, int catId)
		{
			...
			if (ModelState.IsValid)
			{
				...
				else
				{
					...
					existingProduct.Descrition = product.Descrition;
					...
					try
					{
						await products.UpgateAsync(existingProduct);
					}
					catch (Exception ex)
					{
